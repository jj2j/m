...
def masg(call):
	...
	if call.data =="SidraTools":
		...
		M = types.InlineKeyboardButton('المطور', url='https://t.me/BQBXB)
		...
		while True:
			...
			username = str(us)+str(un)+str(un)+str(un)+str(un)+str(un)+str(un)
...
if __name__ == "__main__":
    bot.remove_webhook()
    bot.set_webhook(url="https://tc0e.herokuapp.com/"+str(BOT_TOKEN))
